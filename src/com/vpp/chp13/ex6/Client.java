package com.vpp.chp13.ex6;

import org.springframework.context.support.ClassPathXmlApplicationContext;

import com.vpp.chp13.ex6.domain.Customer;
import com.vpp.chp13.ex6.exception.CustomerNotFoundException;
import com.vpp.chp13.ex6.service.CustomerManagementService;

public class Client {
	public static void main(String[] args) {
		ClassPathXmlApplicationContext container = new ClassPathXmlApplicationContext("chp13.6.xml");
